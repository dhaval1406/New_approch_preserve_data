...
# Data clean up -----------------------------------------------------------
  ...
  intersect(cat.id.not.found$keyword, cat.id.orig$V1)
  intersect(web.id.not.found$keyword, web.id.orig$V1)

  setdiff(cat.id.not.found$keyword, cat.id.orig$V1)
  setdiff(web.id.not.found$keyword, web.id.orig$V1)
